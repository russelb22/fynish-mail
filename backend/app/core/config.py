...
SPAM_RESCUE_MAX_SYNC_MESSAGES_PER_ACCOUNT = _getenv_int(
    "FYNISH_SPAM_RESCUE_MAX_SYNC_MESSAGES_PER_ACCOUNT",
    50,
)
SPAM_RESCUE_LOOKBACK_DAYS = _getenv_int("FYNISH_SPAM_RESCUE_LOOKBACK_DAYS", 30)
